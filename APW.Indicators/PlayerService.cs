...
public class PlayerService : IPlayerService
{
    ...
    public PlayerSource All  { get { return this._playerSource; } }
    ...
    public IEnumerable<Player> GetAllPlayersByTeam(string teamName)
    {
        ...
        var test = from player in players
                   where player.Club == teamName
                   select player;
        // linq to sql

        return players.Where(p => p.Club.Equals(teamName)); 
        // ToList()
